...
const formSchema = z.object({
  ...
  category: z.enum(['Milk-Based', 'Flour-Based', 'Nut-Based', 'Frozen']),
...
export function SweetForm({ sweet }: { sweet?: Sweet }) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      price: sweet?.price || 0,
      category: sweet?.category || 'Milk-Based',
      stock: sweet?.stock || 0,
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <Input type="number" step="1" placeholder="280" {...field} />
                </FormControl>
                <FormMessage />
                </FormItem>
            )}
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Flour-Based">Flour-Based</SelectItem>
                  <SelectItem value="Nut-Based">Nut-Based</SelectItem>
